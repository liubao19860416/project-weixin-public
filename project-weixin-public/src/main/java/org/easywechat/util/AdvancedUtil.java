...
import com.zxytech.message.resp.Music;
import com.zxytech.pojo.SNSUserInfo;
import com.zxytech.pojo.WeixinGroup;
import com.zxytech.pojo.WeixinMedia;
import com.zxytech.pojo.WeixinOauth2Token;
import com.zxytech.pojo.WeixinQRCode;
import com.zxytech.pojo.WeixinUserInfo;
import com.zxytech.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static String makeMusicCustomMessage(String openId, Music music) {
		...
		jsonMsg = String.format(jsonMsg, openId, JSONObject.toJSONString(music).toString());
